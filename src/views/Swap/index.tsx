  ...
  const handleChangePercent = useCallback(
    (sliderPercent: number) => {
      if (maxAmountInput) {
        onUserInput(
          Field.INPUT,
          new BigNumber(maxAmountInput.numerator.toString())
            .div(maxAmountInput.denominator.toString())
            .multipliedBy(sliderPercent / 100)
            .toFixed(maxAmountInput.currency.decimals),
        )
      }
    },
    [maxAmountInput, onUserInput],
