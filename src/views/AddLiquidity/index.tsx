...
import { currencyEquals, ETHER, JSBI, TokenAmount, WETH, MINIMUM_LIQUIDITY } from '@orbitalswap/sdk'
import {
  Button,
  Text,
  AddIcon,
...
export default function AddLiquidity() {
  ...
  const [currencyIdA, currencyIdB] = router.query.currency || [tokens.bnb.symbol, tokens.orb.address]
