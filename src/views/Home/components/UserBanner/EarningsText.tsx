...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and ORB pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and ORB pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from ORB pool', data)
  }
