...
const LotteryCardData: IconCardData = {
  ...
  background: ' linear-gradient(180deg, #9439EC 0%, #5121B1 100%);',
  borderColor: '#3C1786',
  rotation: '1.43deg',
}
...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'ORB card' },
    { src: 'green', alt: 'Green ORB card with up arrow' },
    { src: 'red', alt: 'Red Cake card with down arrow' },
    { src: 'top-right', alt: 'ORB card' },
  ],
}
