    ...
    <Box position="relative" id={id}>
      ...
      {account && (
          <Text
            ...
            color="textSubtle"
            fontSize="14px"
            style={{ display: 'inline', cursor: 'pointer', marginBottom: '10px'}}
          >
            {!hideBalance && !!currency
              ? t('Balance: %balance%', { balance: ethBalance?.toSignificant(6) ?? t('Loading') })
              : ' -'}
          </Text>
        )}
        ...
        <Container as="label" zapStyle={zapStyle} error={error}>
          ...
          <InputRow selected={disableCurrencySelect}>
            ...
            {account && currency && !disabled && showMaxButton && label !== 'To' && (
              <Button onClick={onMax} scale="xs" variant="outlined">
